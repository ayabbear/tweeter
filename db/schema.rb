...
ActiveRecord::Schema.define(version: 2020_10_30_043306) do
  ...
  create_table "tweet_mentions", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["mention_id"], name: "index_tweet_mentions_on_mention_id"
    t.index ["tweet_id"], name: "index_tweet_mentions_on_tweet_id"
  end
  ...
  add_foreign_key "tweet_mentions", "mentions"
